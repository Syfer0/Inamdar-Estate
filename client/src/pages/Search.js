...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const fetchListings = () => __awaiter(this, void 0, void 0, function* () {
            setLoading(true);
            setShowMore(false);
            const searchQuery = urlParams.toString();
            const res = yield fetch(`/api/listing/get?${searchQuery}`);
    ...
    const handleChange = (e) => {
        if (e.target.id === 'all' ||
            e.target.id === 'rent' ||
            e.target.id === 'sale') {
            setSidebardata(Object.assign(Object.assign({}, sidebardata), { type: e.target.id }));
        }
        if (e.target.id === 'searchTerm') {
            setSidebardata(Object.assign(Object.assign({}, sidebardata), { searchTerm: e.target.value }));
        }
        if (e.target.id === 'parking' ||
            e.target.id === 'furnished' ||
            e.target.id === 'offer') {
            setSidebardata(Object.assign(Object.assign({}, sidebardata), { [e.target.id]: e.target.checked || e.target.checked === 'true' ? true : false }));
        }
        if (e.target.id === 'sort_order') {
            const sort = e.target.value.split('_')[0] || 'created_at';
            const order = e.target.value.split('_')[1] || 'desc';
            setSidebardata(Object.assign(Object.assign({}, sidebardata), { sort, order }));
        }
    };
    ...
    const onShowMoreClick = () => __awaiter(this, void 0, void 0, function* () {
